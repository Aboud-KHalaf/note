...
class FetchAllRemoteNotesUsecase extends UseCase<Unit, NoParameter> {
  final NoteRepository noteRepository;
  FetchAllRemoteNotesUsecase({required this.noteRepository});
  @override
  Future<Either<Failure, Unit>> call([NoParameter? parm]) {
    return noteRepository.fetchAllRemoteNotes();
  }
}
